    ...
    for item in items:
        ...
        for indicator in item.get("positive_indicators", []):
            for val in results.values():
                ...
                if indicator in val_str and (
                    "true" in val_str.lower()
                    or "exist" in val_str.lower()
                    or "found" in val_str.lower()
                ):
                    bonus += 1
                    break
        ...
        for indicator in item.get("negative_indicators", []):
            for val in results.values():
                val_str = json.dumps(val) if isinstance(val, dict) else str(val)
                if indicator in val_str and (
                    "false" in val_str.lower()
                    or "not found" in val_str.lower()
                    or "missing" in val_str.lower()
                ):
                    bonus -= 1
                    break
        ...
        "items": [
            {
                ...
                "name": "项目全局描述文档",
                "base_score": 5,
                "positive_indicators": ["README.md", "ARCHITECTURE.md"],
                "negative_indicators": [],
            },
            {
                "id": "1.2",
                "name": "目录结构清晰度",
                "base_score": 5,
                "positive_indicators": ["semantic", "layers", "structure"],
                "negative_indicators": ["flat", "cluttered"],
            },
            {
                "id": "1.3",
                "name": "命名规范一致性",
                "base_score": 5,
                "positive_indicators": ["eslint", "consistent", "naming"],
                "negative_indicators": ["inconsistent", "mixed"],
            },
            {
                "id": "1.4",
                "name": "内联文档与注释质量",
                "base_score": 4,
                "positive_indicators": ["docstring", "jsdoc", "comments"],
                "negative_indicators": ["no_comments", "missing"],
            },
            {
                "id": "1.5",
                "name": "依赖关系透明度",
                "base_score": 5,
                "positive_indicators": ["lock_file", "lockfile", "dependency"],
                "negative_indicators": ["circular", "implicit"],
            },
        ],
    },
    "D2": {
        ...
        "items": [
            {
                ...
                "name": "类型系统完备性",
                "base_score": 4,
                "positive_indicators": ["typescript", "pydantic", "strict"],
                "negative_indicators": ["any", "untyped"],
            },
            {
                "id": "2.2",
                "name": "接口契约定义",
                "base_score": 3,
                "positive_indicators": ["openapi", "swagger", "graphql", "protobuf"],
                "negative_indicators": [],
            },
            {
                "id": "2.3",
                "name": "数据校验与Schema定义",
                "base_score": 4,
                "positive_indicators": ["zod", "joi", "pydantic", "schema"],
                "negative_indicators": ["no_validation"],
            },
            {
                "id": "2.4",
                "name": "模块接口边界",
                "base_score": 4,
                "positive_indicators": ["interface", "abstract", "di"],
                "negative_indicators": ["coupled", "concrete"],
            },
            {
                "id": "2.5",
                "name": "配置规约与环境管理",
                "base_score": 5,
                "positive_indicators": [".env", "env.example", "config"],
                "negative_indicators": ["hardcoded"],
            },
        ],
    },
    "D3": {
        ...
        "items": [
            {
                ...
                "name": "测试覆盖与验证机制",
                "base_score": 4,
                "positive_indicators": ["test", "spec", "coverage"],
                "negative_indicators": ["no_tests", "missing"],
            },
            {
                "id": "3.2",
                "name": "Lint/格式化强制约束",
                "base_score": 5,
                "positive_indicators": ["eslint", "prettier", "ruff", "black"],
                "negative_indicators": [],
            },
            {
                "id": "3.3",
                "name": "变更范围可控性",
                "base_score": 4,
                "positive_indicators": ["CODEOWNERS", "monorepo", "workspace"],
                "negative_indicators": ["coupled"],
            },
            {
                "id": "3.4",
                "name": "版本控制与回滚能力",
                "base_score": 5,
                "positive_indicators": ["conventional", "changelog", "commit"],
                "negative_indicators": ["force_push", "no_branch"],
            },
            {
                "id": "3.5",
                "name": "权限与安全模型",
                "base_score": 5,
                "positive_indicators": ["gitignore", "secrets", "vault"],
                "negative_indicators": ["hardcoded_secret", "exposed"],
            },
        ],
    },
    "D4": {
        ...
        "items": [
            {
                ...
                "name": "构建与运行便捷性",
                "base_score": 5,
                "positive_indicators": ["Makefile", "docker-compose", "devcontainer"],
                "negative_indicators": [],
            },
            {
                "id": "4.2",
                "name": "错误反馈质量",
                "base_score": 4,
                "positive_indicators": ["error_type", "structured", "trace"],
                "negative_indicators": ["generic_error", "silent"],
            },
            {
                "id": "4.3",
                "name": "脚本与自动化工具",
                "base_score": 5,
                "positive_indicators": ["scripts", "make", "taskfile"],
                "negative_indicators": ["manual", "missing"],
            },
            {
                "id": "4.4",
                "name": "可调试与可观测性",
                "base_score": 4,
                "positive_indicators": ["launch.json", "logging", "opentelemetry"],
                "negative_indicators": ["console_log_only"],
            },
            {
                "id": "4.5",
                "name": "增量构建与热重载",
                "base_score": 4,
                "positive_indicators": ["hmr", "watch", "vite", "webpack"],
                "negative_indicators": ["full_rebuild"],
            },
        ],
    },
    "D5": {
        ...
        "items": [
            {
                ...
                "name": "设计模式一致性",
                "base_score": 4,
                "positive_indicators": ["adr", "pattern", "consistent"],
                "negative_indicators": ["mixed_patterns"],
            },
            {
                "id": "5.2",
                "name": "可扩展性设计",
                "base_score": 4,
                "positive_indicators": ["plugin", "middleware", "hook"],
                "negative_indicators": ["rigid", "switch_case"],
            },
            {
                "id": "5.3",
                "name": "知识库与决策记录",
                "base_score": 3,
                "positive_indicators": ["CLAUDE.md", "CONTRIBUTING.md", "adr", "docs"],
                "negative_indicators": [],
            },
            {
                "id": "5.4",
                "name": "重构安全网",
                "base_score": 4,
                "positive_indicators": ["type", "test", "ci"],
                "negative_indicators": ["no_safety"],
            },
            {
                "id": "5.5",
                "name": "Agent专属指引文件",
                "base_score": 2,
                "positive_indicators": ["CLAUDE.md", ".cursorrules", "copilot-instructions"],
                "negative_indicators": [],
            },
        ],
    },
...
def build_evaluation_response(dim: str, tool_results: dict) -> dict:
    ...
    for item in scored_items:
        summary_lines.append(
            f"- **{item['id']} {item['name']}**: {item['score']}/10 — {item['reasoning']}"
        )
...
def build_summary_response(messages: list[Message]) -> dict:
    ...
    if not all_dim_results:
        ...
        total_weighted = sum(v.get("weighted_score", 0) for v in all_dim_results.values())
...
async def chat_completions(request: Request):
    ...
    is_summary = any(
        kw in (msg.content or "") for msg in req.messages for kw in DIMENSION_KEYWORDS["SUMMARY"]
    )
...
async def list_models():
    return {
        "object": "list",
        "data": [
            {"id": "mock-gpt-4", "object": "model", "created": int(time.time()), "owned_by": "mock"}
        ],
    }
